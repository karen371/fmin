          ...
          <div class="row mb-4">
           ...
           <div class="row mb-4">
            ...
            <div class="row">
               ...
               <div class="col">
                     <div class="btn-group  " role="group" aria-label="Basic example">
                    <button class="btn btn-outline-danger float-left" type="button" data-bs-toggle="modal" data-bs-target="#modalAgregarS" name="AgregarS" id="AgregarS">Agregar</button>
                    <button class="btn btn-outline-danger float-left" type="button" name="EliminarS" id="EliminarS" >Eliminar</button>
                     </div>
               </div>
            </div>
            <br>
...
<div class="modal fade" id="modalAgregarS" tabindex="-1" aria-labelledby="FormModal" aria-hidden="true">
 <div class="modal-dialog">
  ...
  $.ajax({
     url : "../logica/Documento.php", //pasar el folio, archivo
